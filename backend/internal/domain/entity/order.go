...
func NewOrder(priority string, user_id string, observation string, medicine_id string, quantity int, responsible_id string, order_group_id string, pyxis_id string) *Order {
	return &Order{
		Priority:       priority,
		User_ID:        user_id,
