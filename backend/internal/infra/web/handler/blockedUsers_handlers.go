...
type BlockedUserHandlers struct {
	BlocekdUserUseCase *usecase.BlockedUserUseCase
}

func NewBlockedUserHandlers(blockedUsecase *usecase.BlockedUserUseCase) *BlockedUserHandlers {
	return &MedicineHandlers{
		BlocekdUserUseCase: blockedUsecase,
	}
}
